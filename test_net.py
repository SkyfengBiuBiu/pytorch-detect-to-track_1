...
from model.faster_rcnn.resnet_copy import resnet
...
def parse_args():
  ...
  parser.add_argument('--load_dir', dest='load_dir',
                      help='directory to load models', default="/home/fengy/mnt2/models",
                      type=str)
...
if __name__ == '__main__':
  ...
  if args.net == 'res101':
    ...
    RFCN = resnet(imdb.classes, 18, pretrained=False, class_agnostic=args.class_agnostic)
  else:
