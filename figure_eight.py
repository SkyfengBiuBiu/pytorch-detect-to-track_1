...
# -*- coding: utf-8 -*-
"""
Created on Mon Jul  8 18:19:55 2019
...
def downloadYouTube(video_id,segment,count):
     ...
     try:
         ...
         resolution=yt.resolution.replace('p','')
         return True, {video_id:name},(count+1),{name:resolution}
     except:
         print("Forbidden!")
         return False, {},count,{}
...
if __name__=="__main__":
    ...
    for segment in segments:
        ...
        for _, video in enumerate(video_ids):
            ...
            if idx>=segment_count[segment]-1:
                break
        ...
        for video_b in person_box_dict:
            ...
            resolution_pair=resolution_dict[video_resolution[video_b]]
